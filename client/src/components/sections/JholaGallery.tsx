  ...
  const galleryImages = [
    {
      ...
      alt: "Dr. Anubha Pundir showcasing traditional jhola bags in her garden",
      title: "Traditional Jhola Collection",
      description: "Dr. Anubha Pundir displaying the beautiful handwoven jhola bags that represent our commitment to sustainable living."
    },
    {
      id: 2,
      src: "https://raghukularyawart.org/wp-content/uploads/2025/06/1-WhatsApp-Image-2025-06-30-at-12.17.jpg",
      alt: "Colorful eco-friendly jhola bags demonstration",
      title: "Vibrant Eco-Friendly Designs",
      description: "Showcasing the variety of colors and patterns available in our sustainable jhola bag collection."
    },
    {
      id: 3,
      src: "https://raghukularyawart.org/wp-content/uploads/2025/06/2-WhatsApp-Image-2025-06-30-at-12.17.jpg",
      alt: "Dr. Anubha promoting plastic-free lifestyle with jhola bags",
      title: "Plastic-Free Movement",
      description: "Leading by example, Dr. Anubha demonstrates how simple switches can make a big environmental impact."
    }
  ];
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
            Here from our genuine, supportive, and community-minded team have joined our mission to 
            create a plastic-free, sustainable future.
          </p>
        </motion.div>
